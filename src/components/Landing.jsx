    ...
    <main className="relative pt-32 pb-16 min-h-[calc(100vh-120px)] flex flex-col justify-center items-center px-4 md:px-8 flex-grow w-full max-w-5xl mx-auto z-10">
      <div className="w-full text-center flex flex-col items-center flex-grow justify-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4 w-full mb-12">
          <button 
            className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-lg font-extrabold text-[11px] tracking-[0.2em] uppercase hover:bg-on-surface hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
          ...
          <button 
            className="w-full sm:w-auto px-8 py-4 bg-surface border border-outline text-on-surface rounded-lg font-bold text-[11px] tracking-[0.2em] uppercase hover:border-primary hover:text-primary hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
